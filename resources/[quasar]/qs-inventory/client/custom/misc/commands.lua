...
RegisterCommand('inventory', function()
    ...
    if IsPedFalling(cache.ped) or IsPedRagdoll(cache.ped) or IsPedInParachuteFreeFall(cache.ped) then
        SendTextMessage(Lang('INVENTORY_NOTIFICATION_NOT_ACCESSIBLE'), 'error')
        return
    end
