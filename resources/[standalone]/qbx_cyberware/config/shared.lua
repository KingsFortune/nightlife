...
Config.Implants = {
    ...
    reinforced_tendons = {
        ...
        description = 'Experimental tendon reinforcement allowing enhanced jumping and fall resistance.',
        category = 'mobility',
        ...
        price = 100000,
        effects = {
            jump_height_first = 2.0, -- First jump 2x normal height
            jump_height_double = 3.0, -- Double jump 3x normal height
            can_double_jump = true,
            fall_damage_reduction = 0.75, -- 75% reduced fall damage
            no_ragdoll_on_land = true, -- Don't ragdoll when landing from heights
        },
        visual = {
            enabled = true,
    ...
    adrenaline_booster = {
        ...
        effects = {
            speed_boost = 1.65, -- 65% faster movement
            damage_boost = 1.35, -- 35% more damage (was 20%)
        },
        visual = {
            enabled = true,
